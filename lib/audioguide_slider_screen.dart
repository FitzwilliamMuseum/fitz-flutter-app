...
class AudioGuideSliderPage extends StatefulWidget {
  const AudioGuideSliderPage({Key? key, required this.id}) : super(key: key);

  final String id;

  @override
  _AudioGuideSliderPageState createState() => _AudioGuideSliderPageState();
}

class _AudioGuideSliderPageState extends State<AudioGuideSliderPage> with WidgetsBindingObserver {
...
class _PodcastStopText extends StatelessWidget {
  const _PodcastStopText({Key? key, required this.podcast}) : super(key: key);
  final dynamic podcast;
          ...
          children: [
            Expanded(
              child: Padding(
                ...
                child: Text(podcast[0]['stop_number'].toString(),
                    textAlign: TextAlign.center,
                    style: GoogleFonts.ubuntu(
                        fontSize: 20
                    )),
