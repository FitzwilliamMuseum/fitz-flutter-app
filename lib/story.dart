...
class StoryPage extends StatefulWidget {
  const StoryPage({required this.id});
...
class _StoryPageState extends State<StoryPage> {
  ...
  fetchData(http.Client client,String id) async {
    final uri = "https://content.fitz.ms/fitz-website/items/news_articles?fields=article_title,id,publication_date,*.*&limit=1&filter[id][eq]=" + id;
                ...
                children: [
                  SizedBox(
                    ...
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                          DateFormat.yMMMMd('en_US').format(pubDate!),
                          textAlign: TextAlign.center,
